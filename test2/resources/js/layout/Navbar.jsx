...
import userPhoto from "../../assets/images/img-profileuser.png";
                ...
                <div
                    ...
                    <div className="flex justify-between items-center md:w-[70%]">
                        <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                            <img src={logoExplore} className="h-8" alt="Explore logo" />
                        </a>
                        {/* <!-- search field --> */}
                    ...
                    <div className="flex items-center shrink-0">
                        ...
                        {/* <!-- Dropdown --> */}
                        {/* <div className="z-50 hidden my-4 text-base list-none bg-[rgb(237,237,237,.2)] divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700"
                        ...
                        <div className="flex items-center space-x-3 md:space-x-0 rtl:space-x-reverse">
                            <button type="button" className="flex text-sm bg-gray-400 rounded-full md:me-0"
                                ...
                                <img className="w-8 h-8 rounded-full object-cover" src={userPhoto}
                                    alt="user photo" />
                            </button>
                            {/* <!-- Dropdown menu --> */}
